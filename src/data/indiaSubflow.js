...
export const indiaNodes = [
    ...
    { id: 'IN-IslamExpansion', type: 'default', data: { label: 'イスラーム勢力の東進', type: 'context', details: '中東の[[イスラーム帝国]]が東へ拡大。[[ガズナ朝]]がインド北西部に侵攻し、ヒンドゥー寺院を破壊して大きな富を略奪した。宗教と政治による征服の時代が始まった。', iconUrl: '/icons/islam_expansion.png' }, position: { x: 0, y: 0 }, style: { background: '#713f12', color: '#fff', border: '1px dashed #ca8a04', borderRadius: '4px', width: 220, padding: '10px' } },

    { id: 'IN-Islamic', type: 'default', data: { label: 'イスラーム王朝の侵入', type: 'event', details: '中東からのイスラム教徒の侵入により、[[デリー・スルタン朝]]などが成立。ヒンドゥーとイスラームの文化が激しくぶつかり合った。', subGraphId: 'india_islamic', iconUrl: '/icons/india_islamic_invasion.png' }, position: { x: 0, y: 0 }, style: { background: '#d97706', color: '#fff', border: 'none', borderRadius: '4px', width: 220, padding: '10px' } },
