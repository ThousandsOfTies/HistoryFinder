...
export const grandNodes = [
    ...
    // 帝国主義の結果: 4分岐（各地域の近代）
    // ==========================================
    { id: 'MODERN-Europe', type: 'default', data: { label: '近代のヨーロッパ', type: 'macro_event', iconUrl: '/icons/modern_europe.png', details: '[[フランス革命]]を経て国民国家の時代へ。', subGraphId: 'revolution', manualPosition: true }, position: { x: COL2, y: 1180 }, style: { background: '#2563eb', color: '#fff', border: '2px solid #60a5fa', borderRadius: '4px', width: 180, padding: '10px' } },
    { id: 'MODERN-MiddleEast', type: 'default', data: { label: '近代の中東', type: 'macro_event', iconUrl: '/icons/modern_mid_east.png', details: '[[オスマン帝国]]崩壊後、石油をめぐる大国の介入と対立。', subGraphId: 'modern_mideast', manualPosition: true }, position: { x: COL3, y: 1180 }, style: { background: '#059669', color: '#fff', border: '2px solid #10b981', borderRadius: '4px', width: 180, padding: '10px' } },
    { id: 'MODERN-India', type: 'default', data: { label: '近代のインド', type: 'macro_event', iconUrl: '/icons/modern_india.png', details: '[[イギリス]]による植民地支配から独立と分離へ。', manualPosition: true }, position: { x: COL4, y: 1180 }, style: { background: '#d97706', color: '#fff', border: '2px solid #f59e0b', borderRadius: '4px', width: 180, padding: '10px' } },
    { id: 'MODERN-China', type: 'default', data: { label: '近代の中国', type: 'macro_event', iconUrl: '/icons/modern_china.png', details: '[[辛亥革命]]から[[中華人民共和国]]の成立へ。', subGraphId: 'modern_china', manualPosition: true }, position: { x: COL5, y: 1180 }, style: { background: '#be123c', color: '#fff', border: '2px solid #f43f5e', borderRadius: '4px', width: 180, padding: '10px' } },
