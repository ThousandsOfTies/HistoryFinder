...
export const europeNodes = [
    ...
    { id: 'EU-GermanMigration', type: 'default', data: { label: 'ゲルマン民族の大移動', type: 'context', iconUrl: '/icons/germanic_migration_anime.png', details: '[[フン族]]の西進に押されて[[ゲルマン民族]]が大挙してローマ帝国領に侵入。476年に[[西ローマ帝国]]が滅亡し、ヨーロッパは分裂の時代に入った。' }, position: { x: 0, y: 0 }, style: { background: '#713f12', color: '#fff', border: '1px dashed #ca8a04', borderRadius: '4px', width: 220, padding: '10px' } },
    ...
    { id: 'EU-PapalPower', type: 'default', data: { label: '教皇権の強大化', type: 'context', iconUrl: '/icons/papal_power_anime.png', details: '中世ヨーロッパでは[[ローマ教皇]]の権威が世俗君主を超えるほどに強まった。[[叙任権闘争]]で教皇が皇帝を屈服させ、キリスト教世界の統合者として聖地奪還を号令する力を持った。' }, position: { x: 0, y: 0 }, style: { background: '#713f12', color: '#fff', border: '1px dashed #ca8a04', borderRadius: '4px', width: 220, padding: '10px' } },
