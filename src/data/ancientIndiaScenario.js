...
export const ancientIndiaNodes = [
    // --- 前提条件 (Context & Root Cause) ---
    {
        ...
        data: {
            ...
            iconUrl: '/icons/aryan_migration.png'
        },
    ...
    // --- 大事件とアクション (Event & Action) ---
    {
        ...
        data: {
            label: 'マウリヤ朝による初の統一と\n仏教の保護',
            type: 'event',
            iconUrl: '/icons/ashoka_buddhism.png',
    ...
    },
    {
        ...
        data: {
            ...
            iconUrl: '/icons/mahayana_spread.png'
        },
    ...
    // --- 繁栄の結果と世界史への影響 (Results) ---
    {
        ...
        data: {
            label: 'グプタ朝における\nヒンドゥー教の確立',
            type: 'result',
            iconUrl: '/icons/hinduism_gupta.png',
    ...
    },
    {
        ...
        data: {
            label: 'インド古典文化の完成と波及',
            type: 'result',
            iconUrl: '/icons/indian_classical_culture.png',
